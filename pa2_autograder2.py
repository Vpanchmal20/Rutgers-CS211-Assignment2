...
dict_train= {"testA.txt":"trainA.txt", "testB.txt":"trainB.txt", "testC.txt":"trainC.txt", "testD.txt":"trainD.txt", "testE.txt":"trainE.txt", "testF.txt":"trainF.txt", "testG.txt":"trainG.txt", "testH.txt":"trainH.txt", "testI.txt":"trainI.txt", "testJ.txt":"trainJ.txt", "testK.txt":"trainK.txt", "testL.txt":"trainL.txt", "testM.txt":"trainM.txt", "testN.txt":"trainN.txt", "testO.txt":"trainO.txt", "testP.txt":"trainP.txt", "testQ.txt":"trainQ.txt", "testR.txt":"trainR.txt"}

first_weight = {"testA.txt":2.5, "testB.txt":5.0, "testC.txt":2.5, "testD.txt":2.5, "testE.txt":2.5, "testF.txt":2.5, "testG.txt":2.5, "testH.txt":2.5, "testI.txt":2.5, "testJ.txt":2.5, "testK.txt":5.0, "testL.txt":2.5, "testM.txt":2.5, "testN.txt":2.5, "testO.txt":2.5, "testP.txt":2.5, "testQ.txt":2.5, "testR.txt":2.5}


list_tests= ["testA.txt", "testB.txt", "testC.txt", "testD.txt", "testE.txt", "testF.txt", "testG.txt", "testH.txt", "testI.txt", "testJ.txt", "testK.txt", "testL.txt", "testM.txt", "testN.txt", "testO.txt", "testP.txt", "testQ.txt", "testR.txt"];

dict_results= {"testA.txt":"resultA.txt", "testB.txt":"resultB.txt", "testC.txt":"resultC.txt", "testD.txt":"resultD.txt", "testE.txt":"resultE.txt", "testF.txt":"resultF.txt", "testG.txt":"resultG.txt", "testH.txt":"resultH.txt", "testI.txt":"resultI.txt", "testJ.txt":"resultJ.txt", "testK.txt":"resultK.txt", "testL.txt":"resultL.txt", "testM.txt":"resultM.txt", "testN.txt":"resultN.txt", "testO.txt":"resultO.txt", "testP.txt":"resultP.txt", "testQ.txt":"resultQ.txt", "testR.txt":"resultR.txt"}
...
#            	print "Deleting the directory obj_temp."
    ...
    print "Your EXTRA CREDIT SCORE = ", extra_credit_score, "/25"
